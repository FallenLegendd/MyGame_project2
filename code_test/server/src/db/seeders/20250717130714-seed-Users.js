  ...
  async up(queryInterface, Sequelize) {
    ...
    const questionsData = [
      ...
      },
      {
        ...
        questions: [
          {
            question: "Какой фильм получил первый в истории «Оскар» за лучшую картину?",
            score: 100,
            answers: [
              { text: "Унесённые ветром", correct: false },
              { text: "Крылья", correct: true },
              { text: "Касабланка", correct: false },
              { text: "Крёстный отец", correct: false },
            ],
          },
          {
            question: "Кто сыграл главную роль в фильме «Крёстный отец» (1972)?",
            score: 200,
            answers: [
              { text: "Марлон Брандо", correct: true },
              { text: "Аль Пачино", correct: false },
              { text: "Роберт Де Ниро", correct: false },
              { text: "Джек Николсон", correct: false },
            ],
          },
          {
            question: "Как называется самая кассовая франшиза в истории кино?",
            score: 300,
            answers: [
              { text: "Властелин колец", correct: false },
              { text: "Звёздные войны", correct: false },
              { text: "Мстители", correct: true },
              { text: "Гарри Поттер", correct: false },
            ],
          },
          {
            question: "Какой режиссёр снял фильм «Начало» (2010)?",
            score: 400,
            answers: [
              { text: "Стивен Спилберг", correct: false },
              { text: "Квентин Тарантино", correct: false },
              { text: "Кристофер Нолан", correct: true },
              { text: "Джеймс Кэмерон", correct: false },
            ],
          },
          {
            question: "Фамилия самого бомбового актёра по версии Азамата?",
            score: 500,
            answers: [
              { text: "Петров", correct: false },
              { text: "Дэпп", correct: false },
              { text: "Оганян", correct: true },
              { text: "Питт", correct: false },
            ],
          },
        ],
      },
